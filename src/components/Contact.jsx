...
const Contact = () => {
  return (
    ...
    from-black to bg-gray-800 p-4 text-white">
        ...
        max-w-screen-lg mx-auto h-full">
            ...
            <div className="flex justify-center items-center">
                ...
                <form action="https://getform.io/f/72233726-ed73-4ec3-bdad-856f77850264" 
                className="flex flex-col w-full md:w-1/2"
                method="POST">

                    <input type="text" name="name" 
                    placeholder='Enter Your name' className="p-2 
                    bg-transparent border-2 rounded-md
                    text-white focus:outline-none"/>

                    <input type="text" name="email" 
                    placeholder='Enter Your email' className="p-2 my-4
                    bg-transparent border-2 rounded-md
                    text-white focus:outline-none"/>

                    <textarea name="message" rows="10" placeholder="Enter your message" className="p-2 
                    bg-transparent border-2 rounded-md
                    text-white focus:outline-none">
